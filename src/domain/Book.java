...
public class Book implements Serializable {
	...
	protected Book(int numeroReserva, int cost, UserAplication cliente, Vector<Fechas> fechas) {
	...
	protected Book(int numeroReserva, int cost, UserAplication cliente, Offer oferta, Vector<Fechas> fechas) {
		bookDate = new java.util.Date(System.currentTimeMillis());
		bookNumber = numeroReserva;
		isPaid = false;
		precio = cost;
